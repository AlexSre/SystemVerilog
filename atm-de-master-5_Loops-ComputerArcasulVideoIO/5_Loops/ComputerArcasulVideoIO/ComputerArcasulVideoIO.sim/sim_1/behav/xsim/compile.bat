...
REM
REM Generated by Vivado on Fri Apr 03 22:19:19 +0300 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_CPU_ALU_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_CPU_ALU_vlog.prj -log xvlog.log
